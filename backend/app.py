...
def create_app():
    ...
    # Additional folders for plagiarism checker (using same upload/results )
    os.makedirs("results", exist_ok=True)
    os.makedirs("scraped_data", exist_ok=True)
    os.makedirs("scraped_data/arxiv", exist_ok=True)
    os.makedirs("scraped_data/arxiv/pdfs", exist_ok=True)
    os.makedirs("scraped_data/arxiv/metadata", exist_ok=True)
    os.makedirs("scraped_data/web", exist_ok=True)
    os.makedirs("scraped_data/web/content", exist_ok=True)
    os.makedirs("scraped_data/web/metadata", exist_ok=True)
